...
public class Response {
    ...
    public Integer getRespuestaId() { return respuestaId; }

    public void setRespuestaId(Integer respuestaId) { this.respuestaId = respuestaId; }
    ...
    public Question getPregunta() { return pregunta; }
